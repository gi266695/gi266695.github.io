...
Enum_ObjectPriorities = {
    ...
    PRIORITY_OBJECT_WALL_SHORT: 3,
    PRIORITY_SPRITE_SHORT: 4,
    PRIORITY_OBJECT_PLAYER: 5,  
    PRIORITY_OBJECT_ENEMY_SMALL: 6,
    PRIORITY_OBJECT_ENEMY_LARGE: 7,
    PRIORITY_OBJECT_BULLET_SMALL: 8,
    PRIORITY_OBJECT_BULLET_LARGE: 9,
    PRIORITY_MAP_TILE_WALL_TALL: 10,
    PRIORITY_OBJECT_WALL_TALL: 11,
    PRIORITY_SPRITE_TALL: 12,
    PRIORITY_UI_PROMPT: 13
};
